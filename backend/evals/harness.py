...
Pure functions over already-retrieved chunks - no Qdrant or network needed, so the scoring is fully unit-testable
The runner (`run_eval.py`) supplies real chunks from the live retriever; tests supply synthetic ones
"""
